...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-16 bg-gradient-to-tl from-gray-50 via-blue-50/20 to-gray-50 dark:from-gray-800 dark:via-blue-950/15 dark:to-gray-800 relative overflow-hidden">
